...
OPTIONS_4 = {
    ...
    "pen_hakai": ["チョンボ", "上がり放棄", "軽罰符", "カスタム", "なし"],
...
BASE_RULES_4 = {
    "雀魂（四麻・段位戦）": {
        **_BASE_4_COMMON,
        ...
        "pen_goron_taopai": "なし", "pen_noten_reach": "なし", "pen_reach_bad_ankan": "なし", "pen_hakai": "なし",
    ...
    "Mリーグ公式（四麻）": {
        **_BASE_4_COMMON,
        ...
        "pen_goron_taopai": "チョンボ", "pen_noten_reach": "チョンボ", "pen_reach_bad_ankan": "チョンボ", "pen_hakai": "チョンボ",
...
DEFAULT_4 = {
    **_BASE_4_COMMON,
    ...
    "pen_reach_bad_ankan": "チョンボ", "pen_hakai": "チョンボ",
...
OPTIONS_3 = {
    ...
    "pao_daisangen": ["あり", "なし"],
    "pao_daisushi":  ["あり", "なし"],
    "pao_tsumo":     ["パオが全額（チップ5枚）", "通常精算", "放銃扱い"],
    "pao_ron":       ["パオと振込者で折半（チップ各5枚）", "振込者が全額"],
    # 8. 罰則（状況別）
    "chombo_batsu": ["倍満払い", "満貫払い", "20000点減点", "なし"],
    "chombo_taiou": ["やり直し", "流局扱い", "親なら流局", "なし"],
    "pen_goron_taopai": ["チョンボ", "上がり放棄", "軽罰符", "カスタム", "なし"],
    "pen_noten_reach": ["チョンボ", "上がり放棄", "軽罰符", "カスタム", "なし"],
    "pen_reach_bad_ankan": ["チョンボ", "上がり放棄", "軽罰符", "カスタム", "なし"],
...
CATEGORIES_4 = [
    ...
    ("12. チョンボ", ["chombo_batsu","chombo_memo","chombo_taiou","pen_goron_taopai","pen_noten_reach","pen_reach_bad_ankan","pen_hakai"]),
    ("13. 上がり放棄", ["pen_goron_no_taopai","pen_gonaki_sarashi","pen_kuikae_ihan","pen_tahai"]),
    ("14. 軽罰符", ["keibappu_taiou","pen_gonaki_hassei","pen_shouhai"]),
]
